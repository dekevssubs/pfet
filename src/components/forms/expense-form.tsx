...
import type { Expense, Account, ExpenseCategory } from '@/types'
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                Selecting an account will deduct from its balance.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
          ...
          render={({ field }) => (
            <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
              <div className="space-y-0.5">
                ...
                <FormDescription>
                  Mark this as a recurring expense (e.g., rent, subscription)
                </FormDescription>
              </div>
              <FormControl>
                <Switch
